...
4. $$\frac{d}{dx} sec(x) = sec(x)\cdot tan(x)$$
5. $$\frac{d}{dx}csc(x) = -csc(x)\cdot cot(x)$$
...
2. $$\frac{d}{dx}e^x = e^x$$
3. $$\frac{d}{dx}ln(x) = \frac{1}{x},\ x>0$$
4. $$\frac{d}{dx}ln|x| = \frac{1}{x},\ x\neq 0$$
5. $$\frac{d}{dx}(log_a(x)) = \frac{1}{x\,ln(a)},\ x>0$$
